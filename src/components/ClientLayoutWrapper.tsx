...
export default function ClientLayoutWrapper({ children }: { children: React.ReactNode }) {
    ...
    const isPublicShellRoute = pathname === "/" || pathname === "/Home" || pathname.startsWith("/login") || pathname.startsWith("/signup") || pathname.startsWith("/authenticate") || pathname.startsWith("/auth-callback") || pathname.startsWith("/forgot-password") || pathname.startsWith("/admin/profile") || pathname.startsWith("/feed") || pathname.startsWith("/book-notes");
